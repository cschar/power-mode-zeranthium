...
public class ParticleSpriteVineAnchorAnimated extends Particle{
    ...
    static int flyerScale1 = 2;
    static {

        flyerSprites = new ArrayList<BufferedImage>();
        sprites = new ArrayList<BufferedImage>();
        for(int i=0; i <= 68; i++){
            BufferedImage tmp = ParticleUtils.loadSprite(String.format("/blender/fuzzflyer5/0%03d.png", i));
    ...
    public ParticleSpriteVineAnchorAnimated(int x, int y, int dx, int dy,
        ...
        sprite = ParticleUtils.loadSprite(String.format("/blender/fuzzflyer5/0000.png"));
        sprite2 = ParticleUtils.loadSprite(String.format("/blender/vine/0002.png"));


        int scale2 = 5;
        sprite  =  Scalr.resize(sprite, Scalr.Method.BALANCED,
                sprite.getWidth()/ flyerScale1, sprite.getHeight()/ flyerScale1);
