        ...
        switch (column) {
            ...
            case 2:
                ...
                if (row == SpecialActionSoundConfig.KEYS.COPY.ordinal()) {
                    s = "COPY";
                } else if (row == SpecialActionSoundConfig.KEYS.PASTE.ordinal()) {
                    s = "PASTE";
                } else if (row == SpecialActionSoundConfig.KEYS.BACKSPACE.ordinal()) {
                    s = "BACKSPACE";
                } else if (row == SpecialActionSoundConfig.KEYS.DELETE.ordinal()) {
                    s = "DELETE";
                } else if (row == SpecialActionSoundConfig.KEYS.ENTER.ordinal()) {
                    s = "ENTER";
                }
