...
//        File inputFile = new File(url+"/save_config.txt");
        ...
        assertEquals(options.get(0).getAttribute("value").getValue(), "-12566464");
...
//        XmlSerializer.getJdomSerializer().deserializeInto(pmode3Service, classElement);
