...
dependencies {
    ...
    // Standard test dependencies from catalog
    ...
    testImplementation(libs.remoterobot.fixtures)
    ...
    testImplementation(libs.okhttp3.logging)
    // Video Recording
...
// Modern UI testing configuration
intellijPlatformTesting {
    runIde {
        register("runIdeForUiTests") {
            task {
                this.jvmArgumentProviders += CommandLineArgumentProvider {
                    listOf(
